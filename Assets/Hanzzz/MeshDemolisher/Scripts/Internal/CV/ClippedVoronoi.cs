...
public class ClippedVoronoi
{
    ...
    private List<List<int>> voronoiCellsNeighbors = new List<List<int>>();
    private List<Point3D> voronoiCellsCenters = new List<Point3D>();

    public List<IPointLocation> clipPoints;
    private List<int> clipTetrahedrons;
    private List<(int,int)> clipBoundFaces = new List<(int,int)>(); // (tetrahedronIndex, faceIndex), {0,1,2}, {0,2,3}, {2,1,3}, {0,3,1}}
    private List<int> clipBoundFacesNeighbors = new List<int>(); // {0,1}, {1,2}, {2,0}
    ...
    public void Reset()
    {
        ...
        clipVoronoiCellsExterior = new ();
        clipVoronoiCellsInterior = new ();
        interiorVoronoiCells = new ();

        exteriorPointsCDTMappings = new ();
        exteriorPointsMappings = new ();
    }
